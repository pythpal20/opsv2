    ...
    <div class="card-body">
		...
		<tbody>
			<?php
				...
				$query="SELECT nobpkb, ms.kode_alat, jns_kendaraan, merk, no_mesin, no_rangka, nopol, tgl_stnk, tgl_pajak, wrn_tnkb, lokstnk, lokbpkb
						FROM m_skb ms
				...
				$query1="SELECT nobpkb, ms.kode_alat, jns_kendaraan, merk, no_mesin, no_rangka, nopol, tgl_stnk, tgl_pajak, wrn_tnkb, lokstnk, lokbpkb
						FROM m_skb ms
						JOIN m_kendaraan mk ON ms.kode_alat = mk.kode_alat
			...
			<tr>
                ...
                <td><?php echo $wrntnkb; ?></td>
				<td>
					<a href="fme_skb.php?id=<?php echo $row['nobpkb']; ?>"><i class="material-icons">create</i></a><a href="dlt_skb.php?id=<?php echo $row['nobpkb']; ?>"><i class="material-icons">remove_circle</i></a>
				</td>
			</tr>
			<?php } } else { ?>
			<tr>
