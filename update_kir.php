      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info">
            <h4 class="card-title">Update KIR</h4>
            <p class="card-category">Update KIR Setelah melakukan Proses KIR</p>
          </div>
          <?php
            $id = $_GET['id'];
            $query ="SELECT * FROM m_kir mk JOIN m_kendaraan mkr
            ON mk.kode_alat=mkr.kode_alat
            WHERE mk.kode_alat='$id'";
          ...
          ?>
          <div class="card-body">
            <form method="post" action="kir_update.php">
              <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-floating">No KIR</label>
                    <input type="text" class="form-control" name="nokir" value="<?php echo $row['nokir']; ?>" readonly>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-static">Tanggal KIR</label>
                    <input type="date" class="form-control" name="tgl_kir" value="<?php echo $row['tgl_kir']; ?>">
                  </div>
                </div>
              </div>
