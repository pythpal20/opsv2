      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info">
            <h4 class="card-title">Update Pajak</h4>
            <p class="card-category">Update Pajak Setelah melakukan Pembayaran Pajak</p>
          </div>
          <?php
            $id = $_GET['id'];
          ...
          ?>
          <div class="card-body">
            <form method="post" action="pajak_update.php">
              <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-static">Tanggal Pajak</label>
                    <input type="date" class="form-control" name="tgl_pajak" value="<?php echo $row['tgl_pajak']; ?>">
                  </div>
                </div>
              </div>
