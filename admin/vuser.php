      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="vuser.php">List User</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  ...
                  <p class="card-category">List Data user Peralata</p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="euser.php?id=<?php echo $row['id']; ?>"><i class="material-icons">create</i></a>|<a href="deluser.php?id=<?php echo $row['id']; ?>"><i class="material-icons">remove_circle</i></a>
                          </td>
                        </tr>
						<?php } } else { ?>
						<tr>
