      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="fm_user.php">Tamabah User/Admin</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
					...
					?>
                  <form method="post" action="euseradd.php">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Id</label>
                          <input type="hiden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control dropdown" name="level" id="level">
      ...
      <footer class="footer">
        <div class="container-fluid">
          <nav class="float-left">
            <!-- jika diperlukan bisa buat footer info disini -->
          </nav>
