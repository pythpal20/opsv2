	...
	<div class="col-md-12">
    	<div class="card">
        	<div class="card-header card-header-info">
            	<h4 class="card-title ">Data KIR</h4>
            </div>
    <div class="card-body">
		...
		<tbody>
			<?php
				...
				$query="SELECT mkr.id, nokir, ms.nobpkb, ms.kode_alat, jns_kendaraan, merk, nopol, tgl_kir, lokir
						FROM m_kir mkr
						JOIN m_kendaraan mk ON mkr.kode_alat = mk.kode_alat
				...
				$query1="SELECT mkr.id, nokir, ms.nobpkb, ms.kode_alat, jns_kendaraan, merk, nopol, tgl_kir, lokir
						FROM m_kir mkr
						JOIN m_kendaraan mk ON mkr.kode_alat = mk.kode_alat
						JOIN m_skb ms ON ms.kode_alat = mk.kode_alat
			...
			<tr>
				...
				<td>
					<a href="fme_kir.php?id=<?php echo $row['id']; ?>"><i class="material-icons">create</i></a><a href="dlt_kir.php?id=<?php echo $row['id']; ?>"><i class="material-icons">remove_circle</i></a>
				</td>
			</tr>
			<?php } } else { ?>
			<tr>
